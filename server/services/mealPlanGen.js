...
- Lunch AND dinner both need a REALISTIC away-from-home Option B, not another home-cooked dish - people eat lunch at work, and dinner out, while traveling, or too tired to cook a second version of Option A. For lunch, think office/on-the-go: a build-your-own grain bowl (protein + rice or beans + vegetables, easy on sauce/cheese), a rotisserie chicken or pre-made salad from a grocery store, a deli sandwich or wrap, a poke bowl, a Mediterranean bowl (falafel or hummus for vegetarians/vegans, chicken shawarma for others). For dinner, think eating out or travel: a restaurant grilled protein plate with vegetables (skip the heavy sauce), a grocery rotisserie chicken or pre-cooked salmon with a quick steamed veg side, a poke or Mediterranean bowl, or a hotel-safe option (room service protein + salad, or whatever a nearby grocery has) for nights on the road. If a location is given, prefer chains and grocery staples genuinely common there over generic descriptions. List 2-3 real alternatives in the swap cell separated by "or", not just one - e.g. "a build-your-own chicken and rice bowl, a rotisserie chicken with a pre-made salad, or a turkey sandwich on whole grain". Breakfast can still use a home-cooked or simple Option B since it is more often eaten at home, but don't assume that for lunch or dinner.
